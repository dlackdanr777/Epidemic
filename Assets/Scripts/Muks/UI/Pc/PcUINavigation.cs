...
namespace Muks.PcUI
{
    ...
    {
        public event Action OnChangeViewHandler;
        ...
        public override bool CheckActiveView(string viewName)
        {
            ...
            Debug.LogErrorFormat("{0}에 해당하는 UIView가 존재하지 않습니다.", viewName);
            return false;
        }


        /// <summary>열려있는 UI의 VisibleState를 확인 후 bool값을 리턴하는 함수</summary>
        public bool CheckViewsVisibleState()
        {
